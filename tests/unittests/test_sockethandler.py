...
class Test_SocketHandler_add_domain(SocketHandlerTest):
    ...
    def test_new_domain(self):
        self.socket_handler.domains = {}
        self.socket_handler._add_domain("MockDomain", {})

        self.assertEqual({"MockDomain": {}}, self.socket_handler.domains)
        self.assertEqual({"MockDomain": []}, self.socket_handler.events)
    ...
    def test_existing_domain(self):
        ...
        self.assertEqual({"MockDomain": {}}, self.socket_handler.domains)
        self.assertEqual({"MockDomain": mock_events}, self.socket_handler.events)
...
class Test_SocketHandler_remove_domain(SocketHandlerTest):
    ...
    def test_existing_domain(self):
        ...
        self.socket_handler.domains = {"MockDomain": {}}
        self.socket_handler._remove_domain("MockDomain")
        self.assertEqual(self.socket_handler.domains, {})

    def test_invalid(self):
        self.socket_handler.domains = {"MockDomain": {}}
        self.socket_handler._remove_domain("InvalidMockDomain")
        self.assertEqual(self.socket_handler.domains, {"MockDomain": {}})
...
class Test_SocketHandler_get_events(SocketHandlerTest):
    ...
    def setUp(self):
        ...
        self.socket_handler.domains = {self.domain: {}}
    ...
    def test_no_clear(self, _flush_messages):
        ...
        self.socket_handler.events = self.mock_events
        ...
        self.assertEqual(self.mock_events, self.socket_handler.events)
    ...
    def test_clear(self, _flush_messages):
        ...
        self.mock_events = {self.domain: [MagicMock()]}
        self.socket_handler.events = copy.deepcopy(self.mock_events)

        events = self.socket_handler.get_events(self.domain, clear=True)

        _flush_messages.assert_called_once_with()
        self.assertEqual(self.mock_events[self.domain], events)
        self.assertEqual([], self.socket_handler.events[self.domain])
